...
AniPalette_AIZ: zoneanimstart

	; 1
	zoneanimpaldecl 4, AnPal_PalAIZ12_1, Normal_palette_line_3+$1A, 12, 2
	dc.b 0
	dc.b 2
	dc.b 4
	dc.b 6
	...
	; 2
	zoneanimpaldecl $13, AnPal_PalAIZ12_2, Normal_palette_line_3+$10, 4, 4
	dc.b 0
	dc.b 4
	dc.b 8
	dc.b 12
