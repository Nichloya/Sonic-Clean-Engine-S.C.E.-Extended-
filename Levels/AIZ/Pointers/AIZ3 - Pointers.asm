...
; ---------------------------------------------------------------------------
		...
		; PLC
		dc.l PLC1_AIZ3_Before							; PLC1
		dc.l PLC2_AIZ3_After							; PLC2
		...
		binclude "Levels/AIZ/Start Location/Sonic/3.bin"
		binclude "Levels/AIZ/Start Location/Knuckles/3.bin"
